...
func (x *EmailRequest) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
const file_proto_email_proto_rawDesc = "" +
	...
	"\fEmailService\x12=\n" +
	"\x10SendConfirmation\x12\x13.email.EmailRequest\x1a\x14.email.EmailResponseB Z\x1epedidos-redis-grpc/proto;emailb\x06proto3"
...
var file_proto_email_proto_depIdxs = []int32{
	0, // 0: email.EmailService.SendConfirmation:input_type -> email.EmailRequest
	1, // 1: email.EmailService.SendConfirmation:output_type -> email.EmailResponse
