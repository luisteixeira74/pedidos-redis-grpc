...
const (
	EmailService_SendConfirmation_FullMethodName = "/email.EmailService/SendConfirmation"
)
...
type EmailServiceClient interface {
	SendConfirmation(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error)
}
...
func (c *emailServiceClient) SendConfirmation(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmailResponse)
	err := c.cc.Invoke(ctx, EmailService_SendConfirmation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServiceServer interface {
	SendConfirmation(context.Context, *EmailRequest) (*EmailResponse, error)
...
func (UnimplementedEmailServiceServer) SendConfirmation(context.Context, *EmailRequest) (*EmailResponse, error) {
...
func _EmailService_SendConfirmation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_SendConfirmation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendConfirmation(ctx, req.(*EmailRequest))
	}
